...
from .models import StudentCourse, Marks, User, AttendanceRange,Faculte
...
class FacAdmin(admin.ModelAdmin):
    list_display = ('name', 'id','uo')
    search_fields = ('name', 'id','uo')
    ordering = ['name']
...
admin.site.register(Faculte,FacAdmin)