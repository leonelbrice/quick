    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_id', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='auth_user.class')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dept', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='auth_user.dept')),
                ('user', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auth_user.course')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auth_user.student')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='course',
            name='dept',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auth_user.dept'),
        ),
        migrations.AddField(
            model_name='class',
            name='dept',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assign', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auth_user.assign')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attendanceclass', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='auth_user.attendanceclass')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auth_user.course')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auth_user.student')),
            ],
        ),
        ...
        migrations.AddField(
            model_name='assign',
            name='class_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auth_user.class'),
        ),
        migrations.AddField(
            model_name='assign',
            name='course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auth_user.course'),
        ),
        migrations.AddField(
            model_name='assign',
            name='teacher',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auth_user.teacher'),
        ),
        migrations.CreateModel(
            name='MarksClass',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('studentcourse', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auth_user.studentcourse')),
            ],
            options={
