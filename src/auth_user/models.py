...
test_name = (
    ...
    ('Travaux pratique', 'Travaux pratique'),
...
class Dept(models.Model):
    id = models.CharField(primary_key='True', max_length=100)
    name = models.CharField(max_length=200)
    faculte=models.ForeignKey(Faculte,on_delete=models.CASCADE,default='FACSCIENCES')
...
#cela veut dire que les 3 champs doivent etre unique ensemble
    class Meta:
...
class MarksClass(models.Model):
    assign = models.ForeignKey(Assign, on_delete=models.CASCADE)
    name = models.CharField(max_length=50, choices=test_name, default='test 1')
        ...
        if hasattr(instance, 'name'):
            ...
            for ass in ass_list:
                try:
                    ...
                    sc.save()
                    sc.marks_set.create(name='test 1')
                    sc.marks_set.create(name='test 2')
                    sc.marks_set.create(name='test 3')
                    sc.marks_set.create(name='Controle continu')
                    sc.marks_set.create(name='Travaux pratique')
                    sc.marks_set.create(name='Session normale')
